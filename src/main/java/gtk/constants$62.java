...
final class constants$62 {
    ...
    static final MethodHandle g_rw_lock_reader_unlock$MH = RuntimeHelper.downcallHandle(
        ...
        constants$62.g_rw_lock_reader_unlock$FUNC
    );
    ...
    static final MethodHandle g_rec_mutex_init$MH = RuntimeHelper.downcallHandle(
        "g_rec_mutex_init",
        constants$62.g_rec_mutex_init$FUNC
    );
    ...
    static final MethodHandle g_rec_mutex_clear$MH = RuntimeHelper.downcallHandle(
        "g_rec_mutex_clear",
        constants$62.g_rec_mutex_clear$FUNC
    );
    ...
    static final MethodHandle g_rec_mutex_lock$MH = RuntimeHelper.downcallHandle(
        "g_rec_mutex_lock",
        constants$62.g_rec_mutex_lock$FUNC
    );
    ...
    static final MethodHandle g_rec_mutex_trylock$MH = RuntimeHelper.downcallHandle(
        "g_rec_mutex_trylock",
        constants$62.g_rec_mutex_trylock$FUNC
    );
    ...
    static final MethodHandle g_rec_mutex_unlock$MH = RuntimeHelper.downcallHandle(
        "g_rec_mutex_unlock",
        constants$62.g_rec_mutex_unlock$FUNC
    );
}
