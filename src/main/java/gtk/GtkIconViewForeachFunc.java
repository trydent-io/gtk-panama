...
public interface GtkIconViewForeachFunc {
    ...
    static MemorySegment allocate(GtkIconViewForeachFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1660.GtkIconViewForeachFunc_UP$MH, fi, constants$1660.GtkIconViewForeachFunc$FUNC, scope);
    }
    static GtkIconViewForeachFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _key, java.lang.foreign.MemorySegment _value, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                constants$1660.GtkIconViewForeachFunc_DOWN$MH.invokeExact(symbol, _key, _value, _user_data);
            } catch (Throwable ex$) {
