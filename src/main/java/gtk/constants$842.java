...
final class constants$842 {
    ...
    static final MethodHandle cairo_user_scaled_font_render_glyph_func_t_UP$MH = RuntimeHelper.upcallHandle(cairo_user_scaled_font_render_glyph_func_t.class, "apply", constants$842.cairo_user_scaled_font_render_glyph_func_t_UP$FUNC);
    ...
    static final MethodHandle cairo_user_scaled_font_render_glyph_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$842.cairo_user_scaled_font_render_glyph_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle cairo_user_scaled_font_text_to_glyphs_func_t_UP$MH = RuntimeHelper.upcallHandle(cairo_user_scaled_font_text_to_glyphs_func_t.class, "apply", constants$842.cairo_user_scaled_font_text_to_glyphs_func_t_UP$FUNC);
    ...
    static final MethodHandle cairo_user_scaled_font_text_to_glyphs_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$842.cairo_user_scaled_font_text_to_glyphs_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle cairo_user_scaled_font_unicode_to_glyph_func_t_UP$MH = RuntimeHelper.upcallHandle(cairo_user_scaled_font_unicode_to_glyph_func_t.class, "apply", constants$842.cairo_user_scaled_font_unicode_to_glyph_func_t_UP$FUNC);
    ...
    static final MethodHandle cairo_user_scaled_font_unicode_to_glyph_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$842.cairo_user_scaled_font_unicode_to_glyph_func_t_DOWN$FUNC
    );
}
