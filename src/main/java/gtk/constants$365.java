...
final class constants$365 {
    ...
    static final MethodHandle pthread_getspecific$MH = RuntimeHelper.downcallHandle(
        "pthread_getspecific",
        constants$365.pthread_getspecific$FUNC
    );
    ...
    static final MethodHandle pthread_setspecific$MH = RuntimeHelper.downcallHandle(
        "pthread_setspecific",
        constants$365.pthread_setspecific$FUNC
    );
    ...
    static final MethodHandle pthread_getcpuclockid$MH = RuntimeHelper.downcallHandle(
        ...
        constants$365.pthread_getcpuclockid$FUNC
    );
    ...
    static final MethodHandle pthread_atfork$__prepare_UP$MH = RuntimeHelper.upcallHandle(pthread_atfork$__prepare.class, "apply", constants$365.pthread_atfork$__prepare_UP$FUNC);
    ...
    static final MethodHandle pthread_atfork$__prepare_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$365.pthread_atfork$__prepare_DOWN$FUNC
    );
    ...
    static final MethodHandle pthread_atfork$__parent_UP$MH = RuntimeHelper.upcallHandle(pthread_atfork$__parent.class, "apply", constants$365.pthread_atfork$__parent_UP$FUNC);
}
