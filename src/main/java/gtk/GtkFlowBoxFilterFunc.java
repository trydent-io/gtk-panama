...
public interface GtkFlowBoxFilterFunc {
    ...
    static MemorySegment allocate(GtkFlowBoxFilterFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1621.GtkFlowBoxFilterFunc_UP$MH, fi, constants$1621.GtkFlowBoxFilterFunc$FUNC, scope);
    }
    static GtkFlowBoxFilterFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$1621.GtkFlowBoxFilterFunc_DOWN$MH.invokeExact(symbol, _row, _user_data);
            } catch (Throwable ex$) {
