...
public interface GBusNameVanishedCallback {
    ...
    static MemorySegment allocate(GBusNameVanishedCallback fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$575.GBusNameVanishedCallback_UP$MH, fi, constants$575.GBusNameVanishedCallback$FUNC, scope);
    }
    static GBusNameVanishedCallback ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _key, java.lang.foreign.MemorySegment _value, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                constants$575.GBusNameVanishedCallback_DOWN$MH.invokeExact(symbol, _key, _value, _user_data);
            } catch (Throwable ex$) {
