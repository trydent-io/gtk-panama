...
final class constants$735 {
    ...
    static final MethodHandle g_settings_set_value$MH = RuntimeHelper.downcallHandle(
        ...
        constants$735.g_settings_set_value$FUNC
    );
    ...
    static final MethodHandle g_settings_get_value$MH = RuntimeHelper.downcallHandle(
        ...
        constants$735.g_settings_get_value$FUNC
    );
    ...
    static final MethodHandle g_settings_get_user_value$MH = RuntimeHelper.downcallHandle(
        ...
        constants$735.g_settings_get_user_value$FUNC
    );
    ...
    static final MethodHandle g_settings_get_default_value$MH = RuntimeHelper.downcallHandle(
        ...
        constants$735.g_settings_get_default_value$FUNC
    );
    ...
    static final MethodHandle g_settings_set$MH = RuntimeHelper.downcallHandleVariadic(
        "g_settings_set",
        constants$735.g_settings_set$FUNC
    );
    ...
    static final MethodHandle g_settings_get$MH = RuntimeHelper.downcallHandleVariadic(
        "g_settings_get",
        constants$735.g_settings_get$FUNC
    );
}
