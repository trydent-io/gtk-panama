...
final class constants$1514 {
    ...
    static final MethodHandle gtk_image_get_icon_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1514.gtk_image_get_icon_name$FUNC
    );
    ...
    static final MethodHandle gtk_image_get_gicon$MH = RuntimeHelper.downcallHandle(
        "gtk_image_get_gicon",
        constants$1514.gtk_image_get_gicon$FUNC
    );
    ...
    static final MethodHandle gtk_image_get_pixel_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1514.gtk_image_get_pixel_size$FUNC
    );
    ...
    static final MethodHandle gtk_image_get_icon_size$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1514.gtk_image_get_icon_size$FUNC
    );
    ...
    static final MethodHandle gtk_entry_get_type$MH = RuntimeHelper.downcallHandle(
        "gtk_entry_get_type",
        constants$1514.gtk_entry_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_entry_new$MH = RuntimeHelper.downcallHandle(
        "gtk_entry_new",
        constants$1514.gtk_entry_new$FUNC
    );
}
