...
final class constants$885 {
    ...
    static final MethodHandle hb_unicode_mirroring_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$885.hb_unicode_mirroring_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_unicode_script_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_unicode_script_func_t.class, "apply", constants$885.hb_unicode_script_func_t_UP$FUNC);
    ...
    static final MethodHandle hb_unicode_script_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$885.hb_unicode_script_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_unicode_compose_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_unicode_compose_func_t.class, "apply", constants$885.hb_unicode_compose_func_t_UP$FUNC);
    ...
    static final MethodHandle hb_unicode_compose_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$885.hb_unicode_compose_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_unicode_decompose_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_unicode_decompose_func_t.class, "apply", constants$885.hb_unicode_decompose_func_t_UP$FUNC);
}
