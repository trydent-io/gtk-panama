...
final class constants$530 {
    ...
    static final MethodHandle g_credentials_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_credentials_get_type$FUNC
    );
    ...
    static final MethodHandle g_credentials_new$MH = RuntimeHelper.downcallHandle(
        "g_credentials_new",
        constants$530.g_credentials_new$FUNC
    );
    ...
    static final MethodHandle g_credentials_to_string$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_credentials_to_string$FUNC
    );
    ...
    static final MethodHandle g_credentials_get_native$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_credentials_get_native$FUNC
    );
    ...
    static final MethodHandle g_credentials_set_native$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_credentials_set_native$FUNC
    );
    ...
    static final MethodHandle g_credentials_is_same_user$MH = RuntimeHelper.downcallHandle(
        ...
        constants$530.g_credentials_is_same_user$FUNC
    );
}
