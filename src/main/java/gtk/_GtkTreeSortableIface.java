 ...
 *     gboolean (*get_sort_column_id)(GtkTreeSortable*,int*,GtkSortType*);
 *     void (*set_sort_column_id)(GtkTreeSortable*,int,GtkSortType);
 *     void (*set_sort_func)(GtkTreeSortable*,int,GtkTreeIterCompareFunc,gpointer,GDestroyNotify);
    ...
    public interface sort_column_changed {
        ...
        static sort_column_changed ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GtkTreeSortableIface.sort_column_changed_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
