...
public interface GRegexEvalCallback {
    ...
    static MemorySegment allocate(GRegexEvalCallback fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$270.GRegexEvalCallback_UP$MH, fi, constants$270.GRegexEvalCallback$FUNC, scope);
    }
    static GRegexEvalCallback ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row1, java.lang.foreign.MemorySegment _row2, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$270.GRegexEvalCallback_DOWN$MH.invokeExact(symbol, _row1, _row2, _user_data);
            } catch (Throwable ex$) {
