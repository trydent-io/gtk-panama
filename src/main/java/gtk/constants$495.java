...
final class constants$495 {
    ...
    static final MethodHandle g_buffered_input_stream_peek$MH = RuntimeHelper.downcallHandle(
        ...
        constants$495.g_buffered_input_stream_peek$FUNC
    );
    ...
    static final MethodHandle g_buffered_input_stream_peek_buffer$MH = RuntimeHelper.downcallHandle(
        ...
        constants$495.g_buffered_input_stream_peek_buffer$FUNC
    );
    ...
    static final MethodHandle g_buffered_input_stream_fill$MH = RuntimeHelper.downcallHandle(
        ...
        constants$495.g_buffered_input_stream_fill$FUNC
    );
    ...
    static final MethodHandle g_buffered_input_stream_fill_async$MH = RuntimeHelper.downcallHandle(
        ...
        constants$495.g_buffered_input_stream_fill_async$FUNC
    );
    ...
    static final MethodHandle g_buffered_input_stream_fill_finish$MH = RuntimeHelper.downcallHandle(
        ...
        constants$495.g_buffered_input_stream_fill_finish$FUNC
    );
    ...
    static final MethodHandle g_buffered_input_stream_read_byte$MH = RuntimeHelper.downcallHandle(
        ...
        constants$495.g_buffered_input_stream_read_byte$FUNC
    );
}
