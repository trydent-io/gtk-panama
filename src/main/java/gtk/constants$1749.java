...
final class constants$1749 {
    ...
    static final MethodHandle gtk_page_setup_load_key_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1749.gtk_page_setup_load_key_file$FUNC
    );
    ...
    static final MethodHandle gtk_page_setup_to_key_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1749.gtk_page_setup_to_key_file$FUNC
    );
    ...
    static final MethodHandle gtk_page_setup_to_gvariant$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1749.gtk_page_setup_to_gvariant$FUNC
    );
    ...
    static final MethodHandle gtk_page_setup_new_from_gvariant$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1749.gtk_page_setup_new_from_gvariant$FUNC
    );
    ...
    static final MethodHandle gtk_paned_get_type$MH = RuntimeHelper.downcallHandle(
        "gtk_paned_get_type",
        constants$1749.gtk_paned_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_paned_new$MH = RuntimeHelper.downcallHandle(
        "gtk_paned_new",
        constants$1749.gtk_paned_new$FUNC
    );
}
