 ...
 *     GdkContentProvider* (*drag_data_get)(GtkTreeDragSource*,GtkTreePath*);
 ...
 * gboolean (*row_draggable)(GtkTreeDragSource*,GtkTreePath*);
    ...
    static final FunctionDescriptor drag_data_get_UP$FUNC = FunctionDescriptor.of(Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    ...
    static final FunctionDescriptor drag_data_get_DOWN$FUNC = FunctionDescriptor.of(Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    ...
    public interface drag_data_get {
        ...
        static drag_data_get ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GtkTreeDragSourceIface.drag_data_get_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
