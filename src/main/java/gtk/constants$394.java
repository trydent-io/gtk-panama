...
final class constants$394 {
    ...
    static final MethodHandle g_param_spec_pool_list_owned$MH = RuntimeHelper.downcallHandle(
        ...
        constants$394.g_param_spec_pool_list_owned$FUNC
    );
    ...
    static final MethodHandle g_param_spec_pool_list$MH = RuntimeHelper.downcallHandle(
        ...
        constants$394.g_param_spec_pool_list$FUNC
    );
    ...
    static final MethodHandle GCallback_UP$MH = RuntimeHelper.upcallHandle(GCallback.class, "apply", constants$394.GCallback_UP$FUNC);
    ...
    static final MethodHandle GCallback_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$394.GCallback_DOWN$FUNC
    );
    ...
    static final MethodHandle GClosureNotify_UP$MH = RuntimeHelper.upcallHandle(GClosureNotify.class, "apply", constants$394.GClosureNotify_UP$FUNC);
    ...
    static final MethodHandle GClosureNotify_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$394.GClosureNotify_DOWN$FUNC
    );
}
