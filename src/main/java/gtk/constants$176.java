...
final class constants$176 {
    ...
    static final MethodHandle g_source_remove$MH = RuntimeHelper.downcallHandle(
        "g_source_remove",
        constants$176.g_source_remove$FUNC
    );
    ...
    static final MethodHandle g_source_remove_by_user_data$MH = RuntimeHelper.downcallHandle(
        ...
        constants$176.g_source_remove_by_user_data$FUNC
    );
    ...
    static final MethodHandle g_source_remove_by_funcs_user_data$MH = RuntimeHelper.downcallHandle(
        ...
        constants$176.g_source_remove_by_funcs_user_data$FUNC
    );
    ...
    static final MethodHandle GClearHandleFunc_UP$MH = RuntimeHelper.upcallHandle(GClearHandleFunc.class, "apply", constants$176.GClearHandleFunc_UP$FUNC);
    ...
    static final MethodHandle GClearHandleFunc_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$176.GClearHandleFunc_DOWN$FUNC
    );
    ...
    static final MethodHandle g_clear_handle_id$MH = RuntimeHelper.downcallHandle(
        "g_clear_handle_id",
        constants$176.g_clear_handle_id$FUNC
    );
}
