...
final class constants$263 {
    ...
    static final MethodHandle g_rand_new_with_seed$MH = RuntimeHelper.downcallHandle(
        ...
        constants$263.g_rand_new_with_seed$FUNC
    );
    ...
    static final MethodHandle g_rand_new_with_seed_array$MH = RuntimeHelper.downcallHandle(
        ...
        constants$263.g_rand_new_with_seed_array$FUNC
    );
    ...
    static final MethodHandle g_rand_free$MH = RuntimeHelper.downcallHandle(
        "g_rand_free",
        constants$263.g_rand_free$FUNC
    );
    ...
    static final MethodHandle g_rand_copy$MH = RuntimeHelper.downcallHandle(
        "g_rand_copy",
        constants$263.g_rand_copy$FUNC
    );
    ...
    static final MethodHandle g_rand_set_seed$MH = RuntimeHelper.downcallHandle(
        "g_rand_set_seed",
        constants$263.g_rand_set_seed$FUNC
    );
}
