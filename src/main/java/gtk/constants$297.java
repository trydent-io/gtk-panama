...
final class constants$297 {
    ...
    static final MethodHandle g_ascii_strup$MH = RuntimeHelper.downcallHandle(
        "g_ascii_strup",
        constants$297.g_ascii_strup$FUNC
    );
    ...
    static final MethodHandle g_str_is_ascii$MH = RuntimeHelper.downcallHandle(
        "g_str_is_ascii",
        constants$297.g_str_is_ascii$FUNC
    );
    ...
    static final MethodHandle g_strcasecmp$MH = RuntimeHelper.downcallHandle(
        "g_strcasecmp",
        constants$297.g_strcasecmp$FUNC
    );
    ...
    static final MethodHandle g_strncasecmp$MH = RuntimeHelper.downcallHandle(
        "g_strncasecmp",
        constants$297.g_strncasecmp$FUNC
    );
