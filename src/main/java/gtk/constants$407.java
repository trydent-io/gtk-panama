...
final class constants$407 {
    ...
    static final MethodHandle GSignalAccumulator_UP$MH = RuntimeHelper.upcallHandle(GSignalAccumulator.class, "apply", constants$407.GSignalAccumulator_UP$FUNC);
    ...
    static final MethodHandle GSignalAccumulator_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$407.GSignalAccumulator_DOWN$FUNC
    );
    ...
    static final MethodHandle g_signal_newv$MH = RuntimeHelper.downcallHandle(
        "g_signal_newv",
        constants$407.g_signal_newv$FUNC
    );
    ...
    static final MethodHandle g_signal_new_valist$MH = RuntimeHelper.downcallHandle(
        "g_signal_new_valist",
        constants$407.g_signal_new_valist$FUNC
    );
    ...
    static final MethodHandle g_signal_new$MH = RuntimeHelper.downcallHandleVariadic(
        "g_signal_new",
        constants$407.g_signal_new$FUNC
    );
    ...
    static final MethodHandle g_signal_new_class_handler$MH = RuntimeHelper.downcallHandleVariadic(
        ...
        constants$407.g_signal_new_class_handler$FUNC
    );
}
