...
public interface __compar_fn_t {
    ...
    static MemorySegment allocate(__compar_fn_t fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$54.__compar_fn_t_UP$MH, fi, constants$54.__compar_fn_t$FUNC, scope);
    }
    static __compar_fn_t ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$54.__compar_fn_t_DOWN$MH.invokeExact(symbol, _row, _user_data);
            } catch (Throwable ex$) {
