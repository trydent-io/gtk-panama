...
final class constants$1680 {
    ...
    static final MethodHandle gtk_label_get_width_chars$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1680.gtk_label_get_width_chars$FUNC
    );
    ...
    static final MethodHandle gtk_label_set_max_width_chars$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1680.gtk_label_set_max_width_chars$FUNC
    );
    ...
    static final MethodHandle gtk_label_get_max_width_chars$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1680.gtk_label_get_max_width_chars$FUNC
    );
    ...
    static final MethodHandle gtk_label_set_lines$MH = RuntimeHelper.downcallHandle(
        "gtk_label_set_lines",
        constants$1680.gtk_label_set_lines$FUNC
    );
    ...
    static final MethodHandle gtk_label_get_lines$MH = RuntimeHelper.downcallHandle(
        "gtk_label_get_lines",
        constants$1680.gtk_label_get_lines$FUNC
    );
    ...
    static final MethodHandle gtk_label_set_wrap$MH = RuntimeHelper.downcallHandle(
        "gtk_label_set_wrap",
        constants$1680.gtk_label_set_wrap$FUNC
    );
}
