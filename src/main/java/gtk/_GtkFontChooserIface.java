 ...
 * int (*get_font_size)(GtkFontChooser*);
    ...
    public interface get_font_size {
        ...
        static get_font_size ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (int)_GtkFontChooserIface.get_font_size_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
