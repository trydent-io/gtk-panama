...
public interface GtkListBoxUpdateHeaderFunc {
    ...
    static MemorySegment allocate(GtkListBoxUpdateHeaderFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1688.GtkListBoxUpdateHeaderFunc_UP$MH, fi, constants$1688.GtkListBoxUpdateHeaderFunc$FUNC, scope);
    }
    static GtkListBoxUpdateHeaderFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _key, java.lang.foreign.MemorySegment _value, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                constants$1689.GtkListBoxUpdateHeaderFunc_DOWN$MH.invokeExact(symbol, _key, _value, _user_data);
            } catch (Throwable ex$) {
