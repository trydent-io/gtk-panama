...
public interface GInstanceInitFunc {
    ...
    static MemorySegment allocate(GInstanceInitFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$377.GInstanceInitFunc_UP$MH, fi, constants$377.GInstanceInitFunc$FUNC, scope);
    }
    static GInstanceInitFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _tag, java.lang.foreign.MemorySegment _data) -> {
            try {
                constants$377.GInstanceInitFunc_DOWN$MH.invokeExact(symbol, _tag, _data);
            } catch (Throwable ex$) {
