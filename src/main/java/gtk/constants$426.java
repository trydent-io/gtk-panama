...
final class constants$426 {
    ...
    static final MethodHandle g_object_connect$MH = RuntimeHelper.downcallHandleVariadic(
        "g_object_connect",
        constants$426.g_object_connect$FUNC
    );
    ...
    static final MethodHandle g_object_disconnect$MH = RuntimeHelper.downcallHandleVariadic(
        "g_object_disconnect",
        constants$426.g_object_disconnect$FUNC
    );
    ...
    static final MethodHandle g_object_setv$MH = RuntimeHelper.downcallHandle(
        "g_object_setv",
        constants$426.g_object_setv$FUNC
    );
    ...
    static final MethodHandle g_object_set_valist$MH = RuntimeHelper.downcallHandle(
        "g_object_set_valist",
        constants$426.g_object_set_valist$FUNC
    );
    ...
    static final MethodHandle g_object_getv$MH = RuntimeHelper.downcallHandle(
        "g_object_getv",
        constants$426.g_object_getv$FUNC
    );
    ...
    static final MethodHandle g_object_get_valist$MH = RuntimeHelper.downcallHandle(
        "g_object_get_valist",
        constants$426.g_object_get_valist$FUNC
    );
}
