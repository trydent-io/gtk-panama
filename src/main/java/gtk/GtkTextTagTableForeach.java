...
public interface GtkTextTagTableForeach {
    ...
    static MemorySegment allocate(GtkTextTagTableForeach fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1866.GtkTextTagTableForeach_UP$MH, fi, constants$1866.GtkTextTagTableForeach$FUNC, scope);
    }
    static GtkTextTagTableForeach ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _tag, java.lang.foreign.MemorySegment _data) -> {
            try {
                constants$1866.GtkTextTagTableForeach_DOWN$MH.invokeExact(symbol, _tag, _data);
            } catch (Throwable ex$) {
