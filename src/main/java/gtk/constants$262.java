...
final class constants$262 {
    ...
    static final MethodHandle g_queue_peek_head_link$MH = RuntimeHelper.downcallHandle(
        ...
        constants$262.g_queue_peek_head_link$FUNC
    );
    ...
    static final MethodHandle g_queue_peek_tail_link$MH = RuntimeHelper.downcallHandle(
        ...
        constants$262.g_queue_peek_tail_link$FUNC
    );
    ...
    static final MethodHandle g_queue_peek_nth_link$MH = RuntimeHelper.downcallHandle(
        ...
        constants$262.g_queue_peek_nth_link$FUNC
    );
    ...
    static final MethodHandle g_queue_link_index$MH = RuntimeHelper.downcallHandle(
        "g_queue_link_index",
        constants$262.g_queue_link_index$FUNC
    );
    ...
    static final MethodHandle g_queue_unlink$MH = RuntimeHelper.downcallHandle(
        "g_queue_unlink",
        constants$262.g_queue_unlink$FUNC
    );
    ...
    static final MethodHandle g_queue_delete_link$MH = RuntimeHelper.downcallHandle(
        "g_queue_delete_link",
        constants$262.g_queue_delete_link$FUNC
    );
}
