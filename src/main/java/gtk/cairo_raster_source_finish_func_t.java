...
public interface cairo_raster_source_finish_func_t {
    ...
    static MemorySegment allocate(cairo_raster_source_finish_func_t fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$862.cairo_raster_source_finish_func_t_UP$MH, fi, constants$862.cairo_raster_source_finish_func_t$FUNC, scope);
    }
    static cairo_raster_source_finish_func_t ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _tag, java.lang.foreign.MemorySegment _data) -> {
            try {
                constants$862.cairo_raster_source_finish_func_t_DOWN$MH.invokeExact(symbol, _tag, _data);
            } catch (Throwable ex$) {
