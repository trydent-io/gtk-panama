 ...
 *     void (*allocate)(GtkCellAreaContext*,int,int);
 *     void (*reset)(GtkCellAreaContext*);
 *     void (*get_preferred_height_for_width)(GtkCellAreaContext*,int,int*,int*);
 *     void (*get_preferred_width_for_height)(GtkCellAreaContext*,int,int*,int*);
 *     gpointer padding[8];
 * };
 * }
 */
    ...
    public interface reset {
        ...
        static reset ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GtkCellAreaContextClass.reset_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
