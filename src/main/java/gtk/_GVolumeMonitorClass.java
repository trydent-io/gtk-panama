    ...
    public interface get_volume_for_uuid {
        ...
        static get_volume_for_uuid ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GVolumeMonitorClass.get_volume_for_uuid_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * GMount* (*get_mount_for_uuid)(GVolumeMonitor*,char*);
    ...
    public interface get_mount_for_uuid {
        ...
        static get_mount_for_uuid ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GVolumeMonitorClass.get_mount_for_uuid_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * GVolume* (*adopt_orphan_mount)(GMount*,GVolumeMonitor*);
    ...
    public interface adopt_orphan_mount {
        ...
        static adopt_orphan_mount ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GVolumeMonitorClass.adopt_orphan_mount_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
