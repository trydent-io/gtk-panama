...
final class constants$971 {
    ...
    static final MethodHandle pango_item_get_type$MH = RuntimeHelper.downcallHandle(
        "pango_item_get_type",
        constants$971.pango_item_get_type$FUNC
    );
    ...
    static final MethodHandle pango_item_new$MH = RuntimeHelper.downcallHandle(
        "pango_item_new",
        constants$971.pango_item_new$FUNC
    );
    ...
    static final MethodHandle pango_item_copy$MH = RuntimeHelper.downcallHandle(
        "pango_item_copy",
        constants$971.pango_item_copy$FUNC
    );
    ...
    static final MethodHandle pango_item_free$MH = RuntimeHelper.downcallHandle(
        "pango_item_free",
        constants$971.pango_item_free$FUNC
    );
    ...
    static final MethodHandle pango_item_split$MH = RuntimeHelper.downcallHandle(
        "pango_item_split",
        constants$971.pango_item_split$FUNC
    );
    ...
    static final MethodHandle pango_item_apply_attrs$MH = RuntimeHelper.downcallHandle(
        ...
        constants$971.pango_item_apply_attrs$FUNC
    );
}
