...
public interface GtkListBoxForeachFunc {
    ...
    static MemorySegment allocate(GtkListBoxForeachFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1693.GtkListBoxForeachFunc_UP$MH, fi, constants$1693.GtkListBoxForeachFunc$FUNC, scope);
    }
    static GtkListBoxForeachFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _key, java.lang.foreign.MemorySegment _value, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                constants$1693.GtkListBoxForeachFunc_DOWN$MH.invokeExact(symbol, _key, _value, _user_data);
            } catch (Throwable ex$) {
