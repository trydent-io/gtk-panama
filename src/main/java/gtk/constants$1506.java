...
final class constants$1506 {
    ...
    static final MethodHandle gtk_tree_model_filter_refilter$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1506.gtk_tree_model_filter_refilter$FUNC
    );
    ...
    static final MethodHandle gtk_tree_model_filter_clear_cache$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1506.gtk_tree_model_filter_clear_cache$FUNC
    );
    ...
    static final MethodHandle GtkEntryCompletionMatchFunc_UP$MH = RuntimeHelper.upcallHandle(GtkEntryCompletionMatchFunc.class, "apply", constants$1506.GtkEntryCompletionMatchFunc_UP$FUNC);
    ...
    static final MethodHandle GtkEntryCompletionMatchFunc_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$1506.GtkEntryCompletionMatchFunc_DOWN$FUNC
    );
    ...
    static final MethodHandle gtk_entry_completion_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1506.gtk_entry_completion_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_entry_completion_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1506.gtk_entry_completion_new$FUNC
    );
}
