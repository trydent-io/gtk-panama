...
final class constants$904 {
    ...
    static final MethodHandle hb_font_get_glyph_h_kerning_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$904.hb_font_get_glyph_h_kerning_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_extents_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_font_get_glyph_extents_func_t.class, "apply", constants$904.hb_font_get_glyph_extents_func_t_UP$FUNC);
    ...
    static final MethodHandle hb_font_get_glyph_extents_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$904.hb_font_get_glyph_extents_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_contour_point_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_font_get_glyph_contour_point_func_t.class, "apply", constants$904.hb_font_get_glyph_contour_point_func_t_UP$FUNC);
    ...
    static final MethodHandle hb_font_get_glyph_contour_point_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$904.hb_font_get_glyph_contour_point_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_font_get_glyph_name_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_font_get_glyph_name_func_t.class, "apply", constants$904.hb_font_get_glyph_name_func_t_UP$FUNC);
}
