...
final class constants$784 {
    ...
    static final MethodHandle g_task_get_source_tag$MH = RuntimeHelper.downcallHandle(
        ...
        constants$784.g_task_get_source_tag$FUNC
    );
    ...
    static final MethodHandle g_task_get_name$MH = RuntimeHelper.downcallHandle(
        "g_task_get_name",
        constants$784.g_task_get_name$FUNC
    );
    ...
    static final MethodHandle g_task_is_valid$MH = RuntimeHelper.downcallHandle(
        "g_task_is_valid",
        constants$784.g_task_is_valid$FUNC
    );
    ...
    static final MethodHandle GTaskThreadFunc_UP$MH = RuntimeHelper.upcallHandle(GTaskThreadFunc.class, "apply", constants$784.GTaskThreadFunc_UP$FUNC);
    ...
    static final MethodHandle GTaskThreadFunc_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$784.GTaskThreadFunc_DOWN$FUNC
    );
    ...
    static final MethodHandle g_task_run_in_thread$MH = RuntimeHelper.downcallHandle(
        ...
        constants$784.g_task_run_in_thread$FUNC
    );
}
