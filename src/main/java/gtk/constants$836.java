...
final class constants$836 {
    ...
    static final MethodHandle cairo_text_path$MH = RuntimeHelper.downcallHandle(
        "cairo_text_path",
        constants$836.cairo_text_path$FUNC
    );
    ...
    static final MethodHandle cairo_glyph_path$MH = RuntimeHelper.downcallHandle(
        "cairo_glyph_path",
        constants$836.cairo_glyph_path$FUNC
    );
    ...
    static final MethodHandle cairo_text_extents$MH = RuntimeHelper.downcallHandle(
        "cairo_text_extents",
        constants$836.cairo_text_extents$FUNC
    );
    ...
    static final MethodHandle cairo_glyph_extents$MH = RuntimeHelper.downcallHandle(
        "cairo_glyph_extents",
        constants$836.cairo_glyph_extents$FUNC
    );
    ...
    static final MethodHandle cairo_font_extents$MH = RuntimeHelper.downcallHandle(
        "cairo_font_extents",
        constants$836.cairo_font_extents$FUNC
    );
    ...
    static final MethodHandle cairo_font_face_reference$MH = RuntimeHelper.downcallHandle(
        ...
        constants$836.cairo_font_face_reference$FUNC
    );
}
