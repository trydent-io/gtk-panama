...
public interface GtkListBoxSortFunc {
    ...
    static MemorySegment allocate(GtkListBoxSortFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1688.GtkListBoxSortFunc_UP$MH, fi, constants$1688.GtkListBoxSortFunc$FUNC, scope);
    }
    static GtkListBoxSortFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row1, java.lang.foreign.MemorySegment _row2, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$1688.GtkListBoxSortFunc_DOWN$MH.invokeExact(symbol, _row1, _row2, _user_data);
            } catch (Throwable ex$) {
