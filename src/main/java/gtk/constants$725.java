...
final class constants$725 {
    ...
    static final MethodHandle g_resource_ref$MH = RuntimeHelper.downcallHandle(
        "g_resource_ref",
        constants$725.g_resource_ref$FUNC
    );
    ...
    static final MethodHandle g_resource_unref$MH = RuntimeHelper.downcallHandle(
        "g_resource_unref",
        constants$725.g_resource_unref$FUNC
    );
    ...
    static final MethodHandle g_resource_load$MH = RuntimeHelper.downcallHandle(
        "g_resource_load",
        constants$725.g_resource_load$FUNC
    );
    ...
    static final MethodHandle g_resource_open_stream$MH = RuntimeHelper.downcallHandle(
        ...
        constants$725.g_resource_open_stream$FUNC
    );
    ...
    static final MethodHandle g_resource_lookup_data$MH = RuntimeHelper.downcallHandle(
        ...
        constants$725.g_resource_lookup_data$FUNC
    );
    ...
    static final MethodHandle g_resource_enumerate_children$MH = RuntimeHelper.downcallHandle(
        ...
        constants$725.g_resource_enumerate_children$FUNC
    );
}
