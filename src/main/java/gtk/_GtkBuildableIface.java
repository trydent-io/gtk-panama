 ...
 *     void (*set_id)(GtkBuildable*,char*);
 *     char* (*get_id)(GtkBuildable*);
 *     void (*add_child)(GtkBuildable*,GtkBuilder*,GObject*,char*);
 *     void (*set_buildable_property)(GtkBuildable*,GtkBuilder*,char*,const GValue*);
 *     GObject* (*construct_child)(GtkBuildable*,GtkBuilder*,char*);
 *     gboolean (*custom_tag_start)(GtkBuildable*,GtkBuilder*,GObject*,char*,GtkBuildableParser*,gpointer*);
 *     void (*custom_tag_end)(GtkBuildable*,GtkBuilder*,GObject*,char*,gpointer);
 *     void (*custom_finished)(GtkBuildable*,GtkBuilder*,GObject*,char*,gpointer);
 *     void (*parser_finished)(GtkBuildable*,GtkBuilder*);
 *     GObject* (*get_internal_child)(GtkBuildable*,GtkBuilder*,char*);
 * };
 * }
 */
public class _GtkBuildableIface {
    ...
    static final FunctionDescriptor set_id_UP$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle set_id_UP$MH = RuntimeHelper.upcallHandle(set_id.class, "apply", _GtkBuildableIface.set_id_UP$FUNC);
    static final FunctionDescriptor set_id_DOWN$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle set_id_DOWN$MH = RuntimeHelper.downcallHandle(
        _GtkBuildableIface.set_id_DOWN$FUNC
    );
    /**
     * {@snippet :
 * void (*set_id)(GtkBuildable*,char*);
    ...
    public interface set_id {
        ...
        static MemorySegment allocate(set_id fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GtkBuildableIface.set_id_UP$MH, fi, _GtkBuildableIface.set_id$FUNC, scope);
        }
        static set_id ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return (java.lang.foreign.MemorySegment _tag, java.lang.foreign.MemorySegment _data) -> {
                try {
                    _GtkBuildableIface.set_id_DOWN$MH.invokeExact(symbol, _tag, _data);
                } catch (Throwable ex$) {
     ...
     * }
     */
    public static MemorySegment set_id$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkBuildableIface.set_id$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void set_id$set(MemorySegment seg, MemorySegment x) {
        _GtkBuildableIface.set_id$VH.set(seg, x);
    }
    public static MemorySegment set_id$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkBuildableIface.set_id$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void set_id$set(MemorySegment seg, long index, MemorySegment x) {
        _GtkBuildableIface.set_id$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static set_id set_id(MemorySegment segment, SegmentScope scope) {
        return set_id.ofAddress(set_id$get(segment), scope);
    }
    ...
    static final MethodHandle get_id_UP$MH = RuntimeHelper.upcallHandle(get_id.class, "apply", _GtkBuildableIface.get_id_UP$FUNC);
    ...
    static final MethodHandle get_id_DOWN$MH = RuntimeHelper.downcallHandle(
        _GtkBuildableIface.get_id_DOWN$FUNC
    );
    /**
     * {@snippet :
 * char* (*get_id)(GtkBuildable*);
    ...
    public interface get_id {
        ...
        static MemorySegment allocate(get_id fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GtkBuildableIface.get_id_UP$MH, fi, _GtkBuildableIface.get_id$FUNC, scope);
        }
        static get_id ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GtkBuildableIface.get_id_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemorySegment get_id$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkBuildableIface.get_id$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment get_id$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkBuildableIface.get_id$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface custom_tag_end {
        ...
        static custom_tag_end ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, java.lang.foreign.MemorySegment __x3, java.lang.foreign.MemorySegment __x4) -> {
                try {
                    _GtkBuildableIface.custom_tag_end_DOWN$MH.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
