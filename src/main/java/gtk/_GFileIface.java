    ...
    public interface get_relative_path {
        ...
        static get_relative_path ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GFileIface.get_relative_path_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * GFile* (*resolve_relative_path)(GFile*,char*);
    ...
    public interface resolve_relative_path {
        ...
        static resolve_relative_path ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GFileIface.resolve_relative_path_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * gboolean (*make_symbolic_link)(GFile*,char*,GCancellable*,GError**);
    ...
    static final FunctionDescriptor _make_symbolic_link_async_UP$FUNC = FunctionDescriptor.ofVoid();
    static final MethodHandle _make_symbolic_link_async_UP$MH = RuntimeHelper.upcallHandle(_make_symbolic_link_async.class, "apply", _GFileIface._make_symbolic_link_async_UP$FUNC);
    static final FunctionDescriptor _make_symbolic_link_async_DOWN$FUNC = FunctionDescriptor.ofVoid();
    static final MethodHandle _make_symbolic_link_async_DOWN$MH = RuntimeHelper.downcallHandle(
        _GFileIface._make_symbolic_link_async_DOWN$FUNC
    );
    /**
     * {@snippet :
 * void (*_make_symbolic_link_async)();
    ...
    public interface _make_symbolic_link_async {
        ...
        void apply();
        static MemorySegment allocate(_make_symbolic_link_async fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GFileIface._make_symbolic_link_async_UP$MH, fi, _GFileIface._make_symbolic_link_async$FUNC, scope);
        }
        static _make_symbolic_link_async ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return () -> {
                try {
                    _GFileIface._make_symbolic_link_async_DOWN$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
     ...
     * }
     */
    public static MemorySegment _make_symbolic_link_async$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GFileIface._make_symbolic_link_async$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void _make_symbolic_link_async$set(MemorySegment seg, MemorySegment x) {
        _GFileIface._make_symbolic_link_async$VH.set(seg, x);
    }
    public static MemorySegment _make_symbolic_link_async$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GFileIface._make_symbolic_link_async$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _make_symbolic_link_async$set(MemorySegment seg, long index, MemorySegment x) {
        _GFileIface._make_symbolic_link_async$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static _make_symbolic_link_async _make_symbolic_link_async(MemorySegment segment, SegmentScope scope) {
    ...
    static final FunctionDescriptor _make_symbolic_link_finish_UP$FUNC = FunctionDescriptor.ofVoid();
    static final MethodHandle _make_symbolic_link_finish_UP$MH = RuntimeHelper.upcallHandle(_make_symbolic_link_finish.class, "apply", _GFileIface._make_symbolic_link_finish_UP$FUNC);
    static final FunctionDescriptor _make_symbolic_link_finish_DOWN$FUNC = FunctionDescriptor.ofVoid();
    static final MethodHandle _make_symbolic_link_finish_DOWN$MH = RuntimeHelper.downcallHandle(
        _GFileIface._make_symbolic_link_finish_DOWN$FUNC
    );
    /**
     * {@snippet :
 * void (*_make_symbolic_link_finish)();
    ...
    public interface _make_symbolic_link_finish {
        ...
        void apply();
        static MemorySegment allocate(_make_symbolic_link_finish fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GFileIface._make_symbolic_link_finish_UP$MH, fi, _GFileIface._make_symbolic_link_finish$FUNC, scope);
        }
        static _make_symbolic_link_finish ofAddress(MemorySegment addr, SegmentScope scope) {
            MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
            return () -> {
                try {
                    _GFileIface._make_symbolic_link_finish_DOWN$MH.invokeExact(symbol);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
     ...
     * }
     */
    public static MemorySegment _make_symbolic_link_finish$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GFileIface._make_symbolic_link_finish$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
     ...
     * }
     */
    public static void _make_symbolic_link_finish$set(MemorySegment seg, MemorySegment x) {
        _GFileIface._make_symbolic_link_finish$VH.set(seg, x);
    }
    public static MemorySegment _make_symbolic_link_finish$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GFileIface._make_symbolic_link_finish$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void _make_symbolic_link_finish$set(MemorySegment seg, long index, MemorySegment x) {
        _GFileIface._make_symbolic_link_finish$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static _make_symbolic_link_finish _make_symbolic_link_finish(MemorySegment segment, SegmentScope scope) {
