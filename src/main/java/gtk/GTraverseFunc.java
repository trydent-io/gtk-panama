...
public interface GTraverseFunc {
    ...
    static MemorySegment allocate(GTraverseFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$321.GTraverseFunc_UP$MH, fi, constants$321.GTraverseFunc$FUNC, scope);
    }
    static GTraverseFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row1, java.lang.foreign.MemorySegment _row2, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$322.GTraverseFunc_DOWN$MH.invokeExact(symbol, _row1, _row2, _user_data);
            } catch (Throwable ex$) {
