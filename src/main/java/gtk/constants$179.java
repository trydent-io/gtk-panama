...
final class constants$179 {
    ...
    static final MemorySegment g_child_watch_funcs$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_child_watch_funcs", constants$179.g_child_watch_funcs$LAYOUT);
    ...
    static final MemorySegment g_idle_funcs$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_idle_funcs", constants$179.g_idle_funcs$LAYOUT);
    ...
    static final MemorySegment g_unix_signal_funcs$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_unix_signal_funcs", constants$179.g_unix_signal_funcs$LAYOUT);
    ...
    static final MemorySegment g_unix_fd_source_funcs$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_unix_fd_source_funcs", constants$179.g_unix_fd_source_funcs$LAYOUT);
    ...
    static final MethodHandle g_unicode_script_to_iso15924$MH = RuntimeHelper.downcallHandle(
        ...
        constants$179.g_unicode_script_to_iso15924$FUNC
    );
    ...
    static final MethodHandle g_unicode_script_from_iso15924$MH = RuntimeHelper.downcallHandle(
        ...
        constants$179.g_unicode_script_from_iso15924$FUNC
    );
}
