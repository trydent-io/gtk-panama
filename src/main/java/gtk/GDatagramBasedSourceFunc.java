...
/**
 * {@snippet :
 * int (*GDatagramBasedSourceFunc)(struct _GDatagramBased* datagram_based,enum  condition,void* user_data);
 * }
 */
public interface GDatagramBasedSourceFunc {
    ...
    static MemorySegment allocate(GDatagramBasedSourceFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$463.GDatagramBasedSourceFunc_UP$MH, fi, constants$463.GDatagramBasedSourceFunc$FUNC, scope);
    }
    static GDatagramBasedSourceFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _datagram_based, int _condition, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$463.GDatagramBasedSourceFunc_DOWN$MH.invokeExact(symbol, _datagram_based, _condition, _user_data);
            } catch (Throwable ex$) {
