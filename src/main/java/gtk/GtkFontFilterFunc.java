...
public interface GtkFontFilterFunc {
    ...
    static MemorySegment allocate(GtkFontFilterFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1624.GtkFontFilterFunc_UP$MH, fi, constants$1624.GtkFontFilterFunc$FUNC, scope);
    }
    static GtkFontFilterFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row1, java.lang.foreign.MemorySegment _row2, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$1625.GtkFontFilterFunc_DOWN$MH.invokeExact(symbol, _row1, _row2, _user_data);
            } catch (Throwable ex$) {
