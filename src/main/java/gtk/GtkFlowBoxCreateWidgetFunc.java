...
public interface GtkFlowBoxCreateWidgetFunc {
    ...
    static MemorySegment allocate(GtkFlowBoxCreateWidgetFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1614.GtkFlowBoxCreateWidgetFunc_UP$MH, fi, constants$1614.GtkFlowBoxCreateWidgetFunc$FUNC, scope);
    }
    static GtkFlowBoxCreateWidgetFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (java.lang.foreign.MemorySegment)constants$1614.GtkFlowBoxCreateWidgetFunc_DOWN$MH.invokeExact(symbol, _item, _user_data);
            } catch (Throwable ex$) {
