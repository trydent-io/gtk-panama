...
final class constants$1841 {
    ...
    static final MethodHandle gtk_stack_sidebar_set_stack$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1841.gtk_stack_sidebar_set_stack$FUNC
    );
    ...
    static final MethodHandle gtk_stack_sidebar_get_stack$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1841.gtk_stack_sidebar_get_stack$FUNC
    );
    ...
    static final MethodHandle gtk_size_group_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1841.gtk_size_group_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_size_group_new$MH = RuntimeHelper.downcallHandle(
        "gtk_size_group_new",
        constants$1841.gtk_size_group_new$FUNC
    );
    ...
    static final MethodHandle gtk_size_group_set_mode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1841.gtk_size_group_set_mode$FUNC
    );
    ...
    static final MethodHandle gtk_size_group_get_mode$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1841.gtk_size_group_get_mode$FUNC
    );
}
