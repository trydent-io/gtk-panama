 ...
 *     void (*inserted_text)(GtkEntryBuffer*,guint,char*,guint);
 *     void (*deleted_text)(GtkEntryBuffer*,guint,guint);
 *     char* (*get_text)(GtkEntryBuffer*,gsize*);
 *     guint (*get_length)(GtkEntryBuffer*);
 *     guint (*insert_text)(GtkEntryBuffer*,guint,char*,guint);
    ...
    public interface get_text {
        ...
        static get_text ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GtkEntryBufferClass.get_text_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
