...
final class constants$1925 {
    ...
    static final MethodHandle gtk_tree_store_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1925.gtk_tree_store_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_tree_store_new$MH = RuntimeHelper.downcallHandleVariadic(
        "gtk_tree_store_new",
        constants$1925.gtk_tree_store_new$FUNC
    );
    ...
    static final MethodHandle gtk_tree_store_newv$MH = RuntimeHelper.downcallHandle(
        "gtk_tree_store_newv",
        constants$1925.gtk_tree_store_newv$FUNC
    );
    ...
    static final MethodHandle gtk_tree_store_set_column_types$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1925.gtk_tree_store_set_column_types$FUNC
    );
    ...
    static final MethodHandle gtk_tree_store_set_value$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1925.gtk_tree_store_set_value$FUNC
    );
    ...
    static final MethodHandle gtk_tree_store_set$MH = RuntimeHelper.downcallHandleVariadic(
        "gtk_tree_store_set",
        constants$1925.gtk_tree_store_set$FUNC
    );
}
