...
final class constants$303 {
    ...
    static final MethodHandle g_string_chunk_insert_len$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_string_chunk_insert_len$FUNC
    );
    ...
    static final MethodHandle g_string_chunk_insert_const$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_string_chunk_insert_const$FUNC
    );
    ...
    static final MethodHandle g_strv_builder_new$MH = RuntimeHelper.downcallHandle(
        "g_strv_builder_new",
        constants$303.g_strv_builder_new$FUNC
    );
    ...
    static final MethodHandle g_strv_builder_unref$MH = RuntimeHelper.downcallHandle(
        ...
        constants$303.g_strv_builder_unref$FUNC
    );
    ...
    static final MethodHandle g_strv_builder_ref$MH = RuntimeHelper.downcallHandle(
        "g_strv_builder_ref",
        constants$303.g_strv_builder_ref$FUNC
    );
    ...
    static final MethodHandle g_strv_builder_add$MH = RuntimeHelper.downcallHandle(
        "g_strv_builder_add",
        constants$303.g_strv_builder_add$FUNC
    );
}
