 ...
 *     void (*response)(GtkNativeDialog*,int);
    ...
    public interface show {
        ...
        static show ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GtkNativeDialogClass.show_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * void (*hide)(GtkNativeDialog*);
    ...
    public interface hide {
        ...
        static hide ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GtkNativeDialogClass.hide_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
