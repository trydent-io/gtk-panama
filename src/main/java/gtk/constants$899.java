...
final class constants$899 {
    ...
    static final MethodHandle hb_font_get_font_h_extents_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$899.hb_font_get_font_h_extents_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_font_get_font_v_extents_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_font_get_font_v_extents_func_t.class, "apply", constants$899.hb_font_get_font_v_extents_func_t_UP$FUNC);
    ...
    static final MethodHandle hb_font_get_font_v_extents_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$899.hb_font_get_font_v_extents_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_font_get_nominal_glyph_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_font_get_nominal_glyph_func_t.class, "apply", constants$899.hb_font_get_nominal_glyph_func_t_UP$FUNC);
    ...
    static final MethodHandle hb_font_get_nominal_glyph_func_t_DOWN$MH = RuntimeHelper.downcallHandle(
        constants$899.hb_font_get_nominal_glyph_func_t_DOWN$FUNC
    );
    ...
    static final MethodHandle hb_font_get_variation_glyph_func_t_UP$MH = RuntimeHelper.upcallHandle(hb_font_get_variation_glyph_func_t.class, "apply", constants$899.hb_font_get_variation_glyph_func_t_UP$FUNC);
}
