    ...
    public interface startup {
        ...
        static startup ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GApplicationClass.startup_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
 ...
 * void (*activate)(GApplication*);
    ...
    public interface activate {
        ...
        static activate ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GApplicationClass.activate_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public interface command_line {
        ...
        static command_line ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _row, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (int)_GApplicationClass.command_line_DOWN$MH.invokeExact(symbol, _row, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * void (*quit_mainloop)(GApplication*);
    ...
    public interface quit_mainloop {
        ...
        static quit_mainloop ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GApplicationClass.quit_mainloop_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * void (*run_mainloop)(GApplication*);
    ...
    public interface run_mainloop {
        ...
        static run_mainloop ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GApplicationClass.run_mainloop_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * void (*shutdown)(GApplication*);
    ...
    public interface shutdown {
        ...
        static shutdown ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GApplicationClass.shutdown_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
