...
final class constants$631 {
    ...
    static final MethodHandle g_file_enumerator_get_child$MH = RuntimeHelper.downcallHandle(
        ...
        constants$631.g_file_enumerator_get_child$FUNC
    );
    ...
    static final MethodHandle g_file_enumerator_iterate$MH = RuntimeHelper.downcallHandle(
        ...
        constants$631.g_file_enumerator_iterate$FUNC
    );
    ...
    static final MethodHandle g_file_icon_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$631.g_file_icon_get_type$FUNC
    );
    ...
    static final MethodHandle g_file_icon_new$MH = RuntimeHelper.downcallHandle(
        "g_file_icon_new",
        constants$631.g_file_icon_new$FUNC
    );
    ...
    static final MethodHandle g_file_icon_get_file$MH = RuntimeHelper.downcallHandle(
        ...
        constants$631.g_file_icon_get_file$FUNC
    );
    ...
    static final MethodHandle g_file_info_get_type$MH = RuntimeHelper.downcallHandle(
        ...
        constants$631.g_file_info_get_type$FUNC
    );
}
