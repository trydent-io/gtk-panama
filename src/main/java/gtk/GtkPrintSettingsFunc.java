...
public interface GtkPrintSettingsFunc {
    ...
    static MemorySegment allocate(GtkPrintSettingsFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1761.GtkPrintSettingsFunc_UP$MH, fi, constants$1761.GtkPrintSettingsFunc$FUNC, scope);
    }
    static GtkPrintSettingsFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        MemorySegment symbol = MemorySegment.ofAddress(addr.address(), 0, scope);
        return (java.lang.foreign.MemorySegment _key, java.lang.foreign.MemorySegment _value, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                constants$1761.GtkPrintSettingsFunc_DOWN$MH.invokeExact(symbol, _key, _value, _user_data);
            } catch (Throwable ex$) {
