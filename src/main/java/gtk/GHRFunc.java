...
public interface GHRFunc {
    ...
    static MemorySegment allocate(GHRFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$140.GHRFunc_UP$MH, fi, constants$140.GHRFunc$FUNC, scope);
    }
    static GHRFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row1, java.lang.foreign.MemorySegment _row2, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$141.GHRFunc_DOWN$MH.invokeExact(symbol, _row1, _row2, _user_data);
            } catch (Throwable ex$) {
