...
final class constants$781 {
    ...
    static final MethodHandle g_subprocess_launcher_take_fd$MH = RuntimeHelper.downcallHandle(
        ...
        constants$781.g_subprocess_launcher_take_fd$FUNC
    );
    ...
    static final MethodHandle g_subprocess_launcher_close$MH = RuntimeHelper.downcallHandle(
        ...
        constants$781.g_subprocess_launcher_close$FUNC
    );
    ...
    static final MethodHandle g_subprocess_launcher_set_child_setup$MH = RuntimeHelper.downcallHandle(
        ...
        constants$781.g_subprocess_launcher_set_child_setup$FUNC
    );
    ...
    static final MethodHandle g_task_get_type$MH = RuntimeHelper.downcallHandle(
        "g_task_get_type",
        constants$781.g_task_get_type$FUNC
    );
    ...
    static final MethodHandle g_task_report_error$MH = RuntimeHelper.downcallHandle(
        "g_task_report_error",
        constants$781.g_task_report_error$FUNC
    );
}
