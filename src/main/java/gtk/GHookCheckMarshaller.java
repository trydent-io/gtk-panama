...
public interface GHookCheckMarshaller {
    ...
    static MemorySegment allocate(GHookCheckMarshaller fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$150.GHookCheckMarshaller_UP$MH, fi, constants$150.GHookCheckMarshaller$FUNC, scope);
    }
    static GHookCheckMarshaller ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$150.GHookCheckMarshaller_DOWN$MH.invokeExact(symbol, _row, _user_data);
            } catch (Throwable ex$) {
