 ...
 *     int (*event)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,GdkEvent*,const GdkRectangle*,GtkCellRendererState);
 *     void (*snapshot)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,GtkSnapshot*,const GdkRectangle*,const GdkRectangle*,GtkCellRendererState,gboolean);
 ...
 *     void (*get_preferred_width)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,int*,int*);
 *     void (*get_preferred_height_for_width)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,int,int*,int*);
 *     void (*get_preferred_height)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,int*,int*);
 *     void (*get_preferred_width_for_height)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,int,int*,int*);
 ...
 * int (*event)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,GdkEvent*,const GdkRectangle*,GtkCellRendererState);
    ...
    static final MethodHandle snapshot_UP$MH = RuntimeHelper.upcallHandle(snapshot.class, "apply", _GtkCellAreaClass.snapshot_UP$FUNC);
    ...
    static final MethodHandle snapshot_DOWN$MH = RuntimeHelper.downcallHandle(
        _GtkCellAreaClass.snapshot_DOWN$FUNC
    );
    /**
     * {@snippet :
 * void (*snapshot)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,GtkSnapshot*,const GdkRectangle*,const GdkRectangle*,GtkCellRendererState,gboolean);
    ...
    public interface snapshot {
        ...
        static MemorySegment allocate(snapshot fi, SegmentScope scope) {
            return RuntimeHelper.upcallStub(_GtkCellAreaClass.snapshot_UP$MH, fi, _GtkCellAreaClass.snapshot$FUNC, scope);
        }
        static snapshot ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment __x0, java.lang.foreign.MemorySegment __x1, java.lang.foreign.MemorySegment __x2, java.lang.foreign.MemorySegment __x3, java.lang.foreign.MemorySegment __x4, java.lang.foreign.MemorySegment __x5, int __x6, int __x7) -> {
                try {
                    _GtkCellAreaClass.snapshot_DOWN$MH.invokeExact(symbol, __x0, __x1, __x2, __x3, __x4, __x5, __x6, __x7);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static MemorySegment snapshot$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)_GtkCellAreaClass.snapshot$VH.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment snapshot$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)_GtkCellAreaClass.snapshot$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public interface copy_context {
        ...
        static copy_context ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GtkCellAreaClass.copy_context_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public interface get_preferred_width {
        ...
        static get_preferred_width ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _tree_column, java.lang.foreign.MemorySegment _cell, java.lang.foreign.MemorySegment _tree_model, java.lang.foreign.MemorySegment _iter, java.lang.foreign.MemorySegment _data) -> {
                try {
                    _GtkCellAreaClass.get_preferred_width_DOWN$MH.invokeExact(symbol, _tree_column, _cell, _tree_model, _iter, _data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
 ...
 * void (*get_preferred_height)(GtkCellArea*,GtkCellAreaContext*,GtkWidget*,int*,int*);
    ...
    public interface get_preferred_height {
        ...
        static get_preferred_height ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _tree_column, java.lang.foreign.MemorySegment _cell, java.lang.foreign.MemorySegment _tree_model, java.lang.foreign.MemorySegment _iter, java.lang.foreign.MemorySegment _data) -> {
                try {
                    _GtkCellAreaClass.get_preferred_height_DOWN$MH.invokeExact(symbol, _tree_column, _cell, _tree_model, _iter, _data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
