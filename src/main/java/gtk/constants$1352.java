...
final class constants$1352 {
    ...
    static final MethodHandle gtk_window_get_icon_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1352.gtk_window_get_icon_name$FUNC
    );
    ...
    static final MethodHandle gtk_window_set_default_icon_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1352.gtk_window_set_default_icon_name$FUNC
    );
    ...
    static final MethodHandle gtk_window_get_default_icon_name$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1352.gtk_window_get_default_icon_name$FUNC
    );
    ...
    static final MethodHandle gtk_window_set_auto_startup_notification$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1352.gtk_window_set_auto_startup_notification$FUNC
    );
    ...
    static final MethodHandle gtk_window_set_modal$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1352.gtk_window_set_modal$FUNC
    );
    ...
    static final MethodHandle gtk_window_get_modal$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1352.gtk_window_get_modal$FUNC
    );
}
