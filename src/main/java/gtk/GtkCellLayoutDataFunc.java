...
public interface GtkCellLayoutDataFunc {
    ...
    static MemorySegment allocate(GtkCellLayoutDataFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1450.GtkCellLayoutDataFunc_UP$MH, fi, constants$1450.GtkCellLayoutDataFunc$FUNC, scope);
    }
    static GtkCellLayoutDataFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _tree_column, java.lang.foreign.MemorySegment _cell, java.lang.foreign.MemorySegment _tree_model, java.lang.foreign.MemorySegment _iter, java.lang.foreign.MemorySegment _data) -> {
            try {
                constants$1450.GtkCellLayoutDataFunc_DOWN$MH.invokeExact(symbol, _tree_column, _cell, _tree_model, _iter, _data);
            } catch (Throwable ex$) {
