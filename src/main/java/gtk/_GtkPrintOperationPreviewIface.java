 ...
 *     void (*render_page)(GtkPrintOperationPreview*,int);
 *     gboolean (*is_selected)(GtkPrintOperationPreview*,int);
    ...
    public interface end_preview {
        ...
        static end_preview ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    _GtkPrintOperationPreviewIface.end_preview_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
