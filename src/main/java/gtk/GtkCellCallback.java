...
public interface GtkCellCallback {
    ...
    static MemorySegment allocate(GtkCellCallback fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1438.GtkCellCallback_UP$MH, fi, constants$1438.GtkCellCallback$FUNC, scope);
    }
    static GtkCellCallback ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$1438.GtkCellCallback_DOWN$MH.invokeExact(symbol, _row, _user_data);
            } catch (Throwable ex$) {
