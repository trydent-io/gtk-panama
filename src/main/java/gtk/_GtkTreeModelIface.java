 ...
 *     void (*rows_reordered)(GtkTreeModel*,GtkTreePath*,GtkTreeIter*,int*);
 *     GtkTreeModelFlags (*get_flags)(GtkTreeModel*);
 *     int (*get_n_columns)(GtkTreeModel*);
 *     GType (*get_column_type)(GtkTreeModel*,int);
 *     gboolean (*get_iter)(GtkTreeModel*,GtkTreeIter*,GtkTreePath*);
 *     GtkTreePath* (*get_path)(GtkTreeModel*,GtkTreeIter*);
 *     void (*get_value)(GtkTreeModel*,GtkTreeIter*,int,GValue*);
 ...
 *     int (*iter_n_children)(GtkTreeModel*,GtkTreeIter*);
 *     gboolean (*iter_nth_child)(GtkTreeModel*,GtkTreeIter*,GtkTreeIter*,int);
    ...
    public interface get_n_columns {
        ...
        static get_n_columns ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (int)_GtkTreeModelIface.get_n_columns_DOWN$MH.invokeExact(symbol, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public interface get_path {
        ...
        static get_path ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _item, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (java.lang.foreign.MemorySegment)_GtkTreeModelIface.get_path_DOWN$MH.invokeExact(symbol, _item, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public interface get_value {
        ...
        static get_value ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _cr, java.lang.foreign.MemorySegment _attr, int _do_path, java.lang.foreign.MemorySegment _data) -> {
                try {
                    _GtkTreeModelIface.get_value_DOWN$MH.invokeExact(symbol, _cr, _attr, _do_path, _data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public interface iter_n_children {
        ...
        static iter_n_children ofAddress(MemorySegment addr, SegmentScope scope) {
            ...
            return (java.lang.foreign.MemorySegment _row, java.lang.foreign.MemorySegment _user_data) -> {
                try {
                    return (int)_GtkTreeModelIface.iter_n_children_DOWN$MH.invokeExact(symbol, _row, _user_data);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
