...
final class constants$279 {
    ...
    static final MethodHandle g_scanner_cur_token$MH = RuntimeHelper.downcallHandle(
        "g_scanner_cur_token",
        constants$279.g_scanner_cur_token$FUNC
    );
    ...
    static final MethodHandle g_scanner_cur_value$MH = RuntimeHelper.downcallHandle(
        "g_scanner_cur_value",
        constants$279.g_scanner_cur_value$FUNC
    );
    ...
    static final MethodHandle g_scanner_cur_line$MH = RuntimeHelper.downcallHandle(
        "g_scanner_cur_line",
        constants$279.g_scanner_cur_line$FUNC
    );
    ...
    static final MethodHandle g_scanner_cur_position$MH = RuntimeHelper.downcallHandle(
        ...
        constants$279.g_scanner_cur_position$FUNC
    );
    ...
    static final MethodHandle g_scanner_eof$MH = RuntimeHelper.downcallHandle(
        "g_scanner_eof",
        constants$279.g_scanner_eof$FUNC
    );
    ...
    static final MethodHandle g_scanner_set_scope$MH = RuntimeHelper.downcallHandle(
        "g_scanner_set_scope",
        constants$279.g_scanner_set_scope$FUNC
    );
}
