...
final class constants$192 {
    ...
    static final MethodHandle g_string_assign$MH = RuntimeHelper.downcallHandle(
        "g_string_assign",
        constants$192.g_string_assign$FUNC
    );
    ...
    static final MethodHandle g_string_truncate$MH = RuntimeHelper.downcallHandle(
        "g_string_truncate",
        constants$192.g_string_truncate$FUNC
    );
    ...
    static final MethodHandle g_string_set_size$MH = RuntimeHelper.downcallHandle(
        "g_string_set_size",
        constants$192.g_string_set_size$FUNC
    );
    ...
    static final MethodHandle g_string_insert_len$MH = RuntimeHelper.downcallHandle(
        "g_string_insert_len",
        constants$192.g_string_insert_len$FUNC
    );
    ...
    static final MethodHandle g_string_append$MH = RuntimeHelper.downcallHandle(
        "g_string_append",
        constants$192.g_string_append$FUNC
    );
    ...
    static final MethodHandle g_string_append_len$MH = RuntimeHelper.downcallHandle(
        "g_string_append_len",
        constants$192.g_string_append_len$FUNC
    );
}
