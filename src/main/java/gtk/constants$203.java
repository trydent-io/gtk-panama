...
final class constants$203 {
    ...
    static final MethodHandle g_io_channel_unix_new$MH = RuntimeHelper.downcallHandle(
        ...
        constants$203.g_io_channel_unix_new$FUNC
    );
    ...
    static final MethodHandle g_io_channel_unix_get_fd$MH = RuntimeHelper.downcallHandle(
        ...
        constants$203.g_io_channel_unix_get_fd$FUNC
    );
    ...
    static final MemorySegment g_io_watch_funcs$SEGMENT = RuntimeHelper.lookupGlobalVariable("g_io_watch_funcs", constants$203.g_io_watch_funcs$LAYOUT);
    ...
    static final MethodHandle g_key_file_error_quark$MH = RuntimeHelper.downcallHandle(
        ...
        constants$203.g_key_file_error_quark$FUNC
    );
    ...
    static final MethodHandle g_key_file_new$MH = RuntimeHelper.downcallHandle(
        "g_key_file_new",
        constants$203.g_key_file_new$FUNC
    );
    ...
    static final MethodHandle g_key_file_ref$MH = RuntimeHelper.downcallHandle(
        "g_key_file_ref",
        constants$203.g_key_file_ref$FUNC
    );
}
