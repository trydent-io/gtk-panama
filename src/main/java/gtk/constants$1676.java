...
final class constants$1676 {
    ...
    static final MethodHandle gtk_label_get_type$MH = RuntimeHelper.downcallHandle(
        "gtk_label_get_type",
        constants$1676.gtk_label_get_type$FUNC
    );
    ...
    static final MethodHandle gtk_label_new$MH = RuntimeHelper.downcallHandle(
        "gtk_label_new",
        constants$1676.gtk_label_new$FUNC
    );
    ...
    static final MethodHandle gtk_label_new_with_mnemonic$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1676.gtk_label_new_with_mnemonic$FUNC
    );
    ...
    static final MethodHandle gtk_label_set_text$MH = RuntimeHelper.downcallHandle(
        "gtk_label_set_text",
        constants$1676.gtk_label_set_text$FUNC
    );
    ...
    static final MethodHandle gtk_label_get_text$MH = RuntimeHelper.downcallHandle(
        "gtk_label_get_text",
        constants$1676.gtk_label_get_text$FUNC
    );
    ...
    static final MethodHandle gtk_label_set_attributes$MH = RuntimeHelper.downcallHandle(
        ...
        constants$1676.gtk_label_set_attributes$FUNC
    );
}
