...
final class constants$585 {
    ...
    static final MethodHandle g_dbus_proxy_get_default_timeout$MH = RuntimeHelper.downcallHandle(
        ...
        constants$585.g_dbus_proxy_get_default_timeout$FUNC
    );
    ...
    static final MethodHandle g_dbus_proxy_set_default_timeout$MH = RuntimeHelper.downcallHandle(
        ...
        constants$585.g_dbus_proxy_set_default_timeout$FUNC
    );
    ...
    static final MethodHandle g_dbus_proxy_get_interface_info$MH = RuntimeHelper.downcallHandle(
        ...
        constants$585.g_dbus_proxy_get_interface_info$FUNC
    );
    ...
    static final MethodHandle g_dbus_proxy_set_interface_info$MH = RuntimeHelper.downcallHandle(
        ...
        constants$585.g_dbus_proxy_set_interface_info$FUNC
    );
    ...
    static final MethodHandle g_dbus_proxy_get_cached_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$585.g_dbus_proxy_get_cached_property$FUNC
    );
    ...
    static final MethodHandle g_dbus_proxy_set_cached_property$MH = RuntimeHelper.downcallHandle(
        ...
        constants$585.g_dbus_proxy_set_cached_property$FUNC
    );
}
