...
public interface GtkTreeViewRowSeparatorFunc {
    ...
    static MemorySegment allocate(GtkTreeViewRowSeparatorFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$1525.GtkTreeViewRowSeparatorFunc_UP$MH, fi, constants$1525.GtkTreeViewRowSeparatorFunc$FUNC, scope);
    }
    static GtkTreeViewRowSeparatorFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _row1, java.lang.foreign.MemorySegment _row2, java.lang.foreign.MemorySegment _user_data) -> {
            try {
                return (int)constants$1526.GtkTreeViewRowSeparatorFunc_DOWN$MH.invokeExact(symbol, _row1, _row2, _user_data);
            } catch (Throwable ex$) {
