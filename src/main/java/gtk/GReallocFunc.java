...
public interface GReallocFunc {
    ...
    static MemorySegment allocate(GReallocFunc fi, SegmentScope scope) {
        return RuntimeHelper.upcallStub(constants$683.GReallocFunc_UP$MH, fi, constants$683.GReallocFunc$FUNC, scope);
    }
    static GReallocFunc ofAddress(MemorySegment addr, SegmentScope scope) {
        ...
        return (java.lang.foreign.MemorySegment _data, long _size) -> {
            try {
                return (java.lang.foreign.MemorySegment)constants$683.GReallocFunc_DOWN$MH.invokeExact(symbol, _data, _size);
            } catch (Throwable ex$) {
